                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-5 col-sm-7 col-xl-8 p-0">
                        ...
                        <p className="mb-0 font-weight-normal d-none d-sm-block">
                          ...
                          power of love, or in other words, a multifaceted
                ...
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">
                      Welcome to Leftist Media Group
                    </h4>
                      ...
                      <div className="row">
                        <div className="col-md-12 grid-margin stretch-card">
                          <div className="card">
                            <div className="card-body">
                              {" "}
                              Leftist Media group is dedicated to Organizing the
                              Left and starting the Revolution.{" "}
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="row">
                        <div className="col-md-12 grid-margin stretch-card">
                          <div className="card">
                            <div className="card-body">
                              ...
                              The goal of overthrowing Capitalism will require
                              many subtasks, as the only way to defeat it is
                              through the power of love, or in other words, a
                              multifaceted attack from every angle possible.{" "}
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="col-md-12 grid-margin stretch-card">
                          <div className="card">
                            <div className="card-body">
                              {" "}
                              There is only a finite amount of time left as
                              Capitalism has sent us near the end of our climate
                              catastrophe and fascist leadership path. As such,
                              Leftist Media Group is creating a number of
                              projects to be community lead, all focused on a
                              specific avenue of dismantling Capitalism one
                              brick at a time.{" "}
                            </div>
                          </div>
                        </div>
                ...
                <div className="col-md-4 grid-margin stretch-card">
                  <div className="card">
                    <div className="card-body">
                      ...
                      <p>
                        {" "}
                        Wade is a community response system made to assist with
                        the development, design, and organization of protests.
                                ...
                                <div className="preview-item border-bottom">
                                  ...
                                  <div className="preview-item-content d-sm-flex flex-grow">
                                    <div className="flex-grow">
                                      ...
                                      <p className="text-muted mb-0">
                                        This course will provide listeners with
                                        a playlist of 80+ downloadable leftist
                                        songs to listen to and reflect on
                                        centered around leftist topics.
                                      </p>
                                    </div>
                      ...
                      <ul className="col-md-4 list-arrow">
                        <li>
                          ...
                          <li>
                            Music
                            <p>
                              Create and share playlists of leftist music
                              tailored to your friends
                            </p>
                          </li>
                        </li>
                        ...
                        <ul>
                          ...
                          <li>
                            ...
                            <p>
                              ...
                              Upon successful transaction, recipient may choose
                              to open a chat with the donor to thank them.{" "}
                              <br />
                            </p>
                          </li>
                          ...
                          <li>
                            ...
                            <li>
                              ...
                              <li>
                                ...
                                or debated. <br />
                                Questions can simply be simply answered or
                                escalated into a formal debate with Debate
                                Blocks. <br />
                                Evidence based, community Debate Blocks. <br />
                                Within traditional debate, you have a thesis or
                                main point, and that's made up of premises or
                                single arguments. <br />
                                Within Sophia, things are the same, but a bit
                                different, Sophia uses rectangular blocks to
                                visualize argumentation. <br />
                                First, there is a main point to be debated that
                                is titled with a debatable thesis eg.
                                "Anarcho-syndaclism is a progression from
                                state-communism", then you can post a premise
                                block to the discussion. <br />
                                Each premise block is a 2D rectangle covered in
                                text. <br />
                                Premise blocks are divided into supporting
                                (green), neutral (grey), or opposing (red).{" "}
                                <br />
                                Multiple premises can connected to a thesis in a
                                one way direction. <br />
                                If someone has thoughts on your premise, they
                                can post a thought, or add a premise to your
                                premise that either supports, opposes or is
                                neutral to your premise. <br />
                                Sophia will generate meaningful, thought
                                progressing ideas and Praxis. <br />
                              </li>
                            </li>
                          </li>
                        </ul>
                    ...
                    <div className="media">
                      ...
                      <div className="row">
                        ...
                        <div className="column">
                          <p>
                            {" "}
                            If you'd like to join the Revolution, send a email
                            to an admin at LeftistMediaGroup@Gmail.com{" "}
                          </p>
                        </div>
                      </div>
                    </div>
