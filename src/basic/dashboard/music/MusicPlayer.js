...
export class MusicPlayer extends Component {
  ...
  playPause(event) {
    ...
    let audio1 = new Audio("https://https://localhost-0.tail5cd89.ts.net:3001/vidChunk?id=failed_state");
                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      <div>
                        ...
                        id="audio1"
                        controls
                        src="https://https://localhost-0.tail5cd89.ts.net:3001/vidChunk?id=failed_state"
