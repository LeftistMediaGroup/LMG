                      ...
                      <div className="col-md-12 grid-margin stretch-card">
                        <div className="card">
                          <div className="card-body">
                            ...
                            Leftist Media Group is creating a number of projects
                            to be community lead, all focused on a specific
                            avenue of dismantling Capitalism one brick at a
                            time.{" "}
                          </div>
                        </div>
                      </div>
                                ...
                                <div className="preview-item-content d-sm-flex flex-grow">
                                  <div className="flex-grow">
                                    ...
                                    <p className="text-muted mb-0">
                                      ...
                                      to listen to and reflect on centered
                                      around leftist topics.
                                    </p>
                                  </div>
                        ...
                        <li>
                          ...
                          <li>
                            ...
                            <li>
                              ...
                              escalated into a formal debate with Debate Blocks.{" "}
                              <br />
                              ...
                              titled with a debatable thesis eg.
                              ...
                              If someone has thoughts on your premise, they can
                              post a thought, or add a premise to your premise
                              that either supports, opposes or is neutral to
                              your premise. <br />
                  ...
                  <div className="media">
                    ...
                    <div className="row">
                      ...
                      <div className="column">
                        <p>
                          {" "}
                          If you'd like to join the Revolution, send a email to
                          an admin at LeftistMediaGroup@Gmail.com{" "}
                        </p>
                      </div>
                    </div>
                  </div>
